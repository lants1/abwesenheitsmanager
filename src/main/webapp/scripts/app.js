...
var abwesenheitsmanagerApp = angular.module('abwesenheitsmanagerApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'abwesenheitsmanagerAppUtils', 'pascalprecht.translate', 'truncate', 'ngCacheBuster']);
